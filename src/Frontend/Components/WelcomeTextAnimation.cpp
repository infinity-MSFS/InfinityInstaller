...
void WelcomeTextAnimation::getText(ImDrawList *drawList, ImVec2 pos) {
    ...
    drawList->AddText(Infinity::Application::GetFont("DefaultLarge"), 40.0f, ImVec2((windowSize.x / 2) - (textSize.x / 2), pos.y), fontColor, g_welcomeTranslations[s_position].c_str());
